...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="{{ route('user_register_create') }}" method="post">
					<span class="login100-form-title">
						User Register
					</span>
                @csrf
                {{-- Name --}}
                <div class="wrap-input100 validate-input" data-validate = "Name is required ex: Sallam">
